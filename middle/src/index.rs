//! This crate::index helps with defining "newtype"-style wrappers around `usize` (or
...
//! ## Other crate::indexs
//!
//! The [`indexed_vec`](https://crate::indexs.io/crates/indexed_vec) crate predates
...
//! might find [`handy`](https://crate::indexs.io/crates/handy),
//! [`slotmap`](https://crate::indexs.io/crates/slotmap), or
//! [`slab`](https://crate::indexs.io/crates/slab) to be closer what you want.
//!
//! ## FAQ
//!
...
//!
//! Yes, although it uses `extern crate::index alloc;`, of course.
//!
...
macro_rules! index_vec {
    ($($tokens:tt)*) => {
        $crate::index::IndexVec::from_vec(vec![$($tokens)*])
    }
}
...
macro_rules! index_box {
    ($($tokens:tt)*) => {
        $crate::index::IndexVec::from_vec(vec![$($tokens)*]).into_boxed_slice()
    }
}
